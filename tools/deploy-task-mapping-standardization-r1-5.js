...
try{
  console.log('=== R1.5.6 1/8 authorize ==='); clasp(['show-authorized-user','--json'],process.cwd());
  ...
  [
    ...
    'applyPreInspectRichLinksR1_5_6',
  ...
  if(!postModule.includes('TASK_MAPPING_STANDARDIZATION_R1_5_6_PREINSPECT_RICH_LINKS_20260922')) throw new Error('POST R1.5.6 marker missing.');
