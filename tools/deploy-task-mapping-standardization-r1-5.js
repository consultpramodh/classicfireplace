...
const RELEASE='TASK_MAPPING_STANDARDIZATION_R1_5_2_PREINSPECT_CALENDAR_REORGANIZATION_20260922';
...
const OUTPUT=path.resolve('task-mapping-standardization-r1-5-2-output');
...
try{
  console.log('=== R1.5.2 1/8 authorize ==='); clasp(['show-authorized-user','--json'],process.cwd());
  ...
  if(!preModule.includes('TASK_MAPPING_STANDARDIZATION_R1_5_1_PREINSPECT_CALENDAR_REORGANIZATION_20260922')) throw new Error('Unexpected PRE standardization version.');
  ...
  [
    'TASK_MAPPING_STANDARDIZATION_R1_5_2_PREINSPECT_CALENDAR_REORGANIZATION_20260922',
  ...
  if(!postModule.includes('TASK_MAPPING_STANDARDIZATION_R1_5_2_PREINSPECT_CALENDAR_REORGANIZATION_20260922')) throw new Error('POST R1.5.2 marker missing.');
