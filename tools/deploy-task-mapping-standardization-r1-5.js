...
const RELEASE='TASK_MAPPING_STANDARDIZATION_R1_5_4_PREINSPECT_LINK_LABEL_20260922';
...
const OUTPUT=path.resolve('task-mapping-standardization-r1-5-4-output');
...
try{
  console.log('=== R1.5.4 1/8 authorize ==='); clasp(['show-authorized-user','--json'],process.cwd());
  ...
  if(!preModule.includes('TASK_MAPPING_STANDARDIZATION_R1_5_3_PREINSPECT_CALENDAR_REORGANIZATION_20260922')) throw new Error('Unexpected PRE standardization version.');
  ...
  [
    'TASK_MAPPING_STANDARDIZATION_R1_5_4_PREINSPECT_LINK_LABEL_20260922',
  ...
  if(!postModule.includes('TASK_MAPPING_STANDARDIZATION_R1_5_4_PREINSPECT_LINK_LABEL_20260922')) throw new Error('POST R1.5.4 marker missing.');
